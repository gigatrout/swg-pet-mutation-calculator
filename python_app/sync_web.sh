...
mkdir -p "$DEST"
for name in index.html main.js app.js hydrolase_app.js hydro_calc.js incubation_calc.js nutrient_alloc_data.js styles.css hydro_combos_data.js pet_mutations_data.js \
